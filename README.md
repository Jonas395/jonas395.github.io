...
* v0.3 migrated to new api 10/8-25
...
- A small collection of utility scripts to use when managing large collections of files.

[File Manipulation Scripts GitHub repo](https://github.com/Jonas395/file_manipulation_scripts)
...
## Convert imperial (JavaScript)

- Browser extension to automatically convert imperial units on websites to metric. (With limited success)

[Convert imperial GitHub repo](https://github.com/Jonas395/convertimperial)
